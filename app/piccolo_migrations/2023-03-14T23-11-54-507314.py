...
native_language_state = {
    ...
    "state_description": """
the bot is waiting for your native language to be entered by you
    """,
}
...
target_language_state = {
    ...
    "state_description": """
the bot is waiting for you to enter the language in which you
...
studying_one_from_four_state = {
    ...
    "state_description": """
{_1}
by choosing this mode, a user gets an opportunity to study his words,
...
custom_translation_state = {
    ...
    "state_description": """
the bot is waiting for your custom translation of the word you are working with
    """,
}
...
my_words_state = {
    ...
    "state_description": """
{_3}
by choosing this mode, a user gets an opportunity to get acquainted with a list
of words in the translation of which he was interested and added for study.
An additional functionality of this mode is the ability to delete words
...
self_test_state = {
    ...
    "state_description": """
{_2}
by choosing this mode, a user gets an opportunity to check himself for knowledge
of the translation of the proposed word. In an interface, the user will be prompted
for the word and its hidden translation. The user notes whether he knows the
translation or not and at any stage can open a hidden translation for self-checking.
    """,
}
...
none_state = {
    "state_name": "None",
    "state_description": """
Using this bot, a user can translate words or short phrases in the <Google Translate>
functionality, save them for study and subsequent self-examination.
...
{_5} - the user gets the opportunity to finish the work being in any of the modes
      and return to the mode {_0}
    """,
}
